...
export default function HomePage() {
  return (
    // <iframe
    //   className="absolute top-0 z-0 min-h-full w-auto min-w-full max-w-none grayscale"
    ...
    <div className="mx-52">
      ...
      <div className=" grid grid-cols-4 gap-6 text-center">
        ...
        <div className="col-span-1 transform rounded-lg transition duration-300 hover:scale-105 hover:shadow-xl ">
          <Link href="/your-url-for-image-2">
            ...
            <p className="mx-4 mb-4 text-left text-gray-400">20. april 2023</p>
      ...
      <div className=" my-8 grid grid-cols-3 gap-12">
        ...
        <div className="col-span-1 ">
          ...
          <p>
            Helhedsorienteret bygherrerådgivning på en bredvifte af kompetencer
            og erfaringer der sætter indi dine behov og værdier.
          </p>
        </div>
        ...
        <div className="col-span-1">
          ...
          <p>
            Optimere og effektivisere processer gennem avanceret automation, der
            fremmer digitalisering og øger produktivitet
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center md:flex-row">
        <div className="w-full md:w-4/5 ">
          ...
          <p className="py-5 text-2xl">
            Vi er en virksomhed, hvor energi, dynamik og innovation mødes for at
            skabe banebrydende løsninger for vores kunder.
            <br />
            <br /> Vi er stolte af at være et hold af talentfulde fagfolk, der
            bringer passion, kreativitet og ekspertise med til hvert projekt, vi
            påtager os.
            <br />
            <br /> Vores innovative tilgang til projektløsning er kombineret med
            vores dedikation til at levere kvalitetsresultater og sikre
            kundetilfredshed.
            <br />
            <br /> Når du vælger os, kan du stole på, at du vælger en partner,
            der er dedikeret til din succes og forpligtet til at hjælpe dig med
            at nå dine mål.
          </p>
          <Link href="/about">
