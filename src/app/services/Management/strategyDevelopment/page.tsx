...
export default function strategyDevelopment() {
  return (
    <>
      ...
      <h1 className="justify-flex my-16 flex items-center justify-center text-2xl font-semibold md:text-5xl">
        <span className="text-left text-black">SIDEN ER UNDER OPDATERING</span>
      </h1>
